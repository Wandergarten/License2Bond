...
### Mr. "Machine Learning in Production - at Scale"
![markus](https://github.com/Wandergarten/License2Bond/blob/main/markus-1.png)

* Spaßkanone mastered 
* Academic background: Industrial Engineering and Management @TU Berlin :rocket:
* Job profile: Machine Learning Engineer
* Tech stack: Data Streaming, Natural Language Processing, Deep Learning, Python, Cloud Computing, F#
* Feel free to contact me via mmuenster@\<big-four-large-letters\>.com: 
